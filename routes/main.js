		...
		endpoints: {
			profileStats: {
				...
				params: {
					...
					background: "Background type (default, bg1, bg2, bg3, bg4, bg5 or color)",
					hex: "Hex color code when background=color",
					version: "Version of the card (mini or full), defaults to mini",
					height: "Custom height for the card",
					supporter: "Show supporter tag (true or false)",
					team: "Show team flag (true or false)",
				},
				example: "/api/profile-stats/tanese?playmode=mania&background=bg4&version=mini",
			},
			userData: {
			...
			rankGraph: {
				...
				example: "/api/rank-graph/tanese?playmode=mania&width=800&height=100",
			},
			api: {
				url: "/api",
				method: "GET",
