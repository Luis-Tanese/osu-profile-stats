...
const renderFullCard = async (data, options = {}) => {
    ...
    <text x="290" y="75" class="text small ans">${formatNumber(
        rankedScore
    )}</text>
    ...
    <text x="290" y="125" class="text small ans">${formatNumber(
        playCount
    )}</text>

    <text x="290" y="140" class="text small">Total Score</text>
    <text x="290" y="150" class="text small ans">${formatNumber(
        totalScore
    )}</text>

    <text x="80" y="130" class="text small">Total Hits</text>
    <text x="80" y="140" class="text small ans">${formatNumber(
        totalHits
    )}</text>
    ...
    <text x="80" y="190" class="text small ans">${formatNumber(
        replaysWatched
    )}</text>

    <text x="180" y="130" class="text small">Play Time</text>
    <text x="180" y="140" class="text small ans">${formatNumber(
        playTime
    )} hours</text>
